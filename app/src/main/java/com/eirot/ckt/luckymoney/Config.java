...
public class Config {
    ...
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.eirot.ckt.luckymoney.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.eirot.ckt.luckymoney.ACCESSBILITY_CONNECT";

    public static final String PREFERENCE_NAME = "config";
    public static final String KEY_ENABLE_LUCKYMONEY = "luckymoney_enabler";
    ...
    public boolean isEnableWechat() {
        return preferences.getBoolean(KEY_ENABLE_LUCKYMONEY, true);
    }
